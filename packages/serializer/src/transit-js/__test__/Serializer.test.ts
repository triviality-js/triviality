...
describe('TransitJSSerializer', () => {
  ...
  class TestObject {
    ...
    @DeNormalize
    public static deNormalize(data: any) {
  ...
  it('Should re-throw deserialize error as SerializerError', () => {
    const serializer = new TransitJSSerializer([]);

    let error: SerializerError | undefined;
    try {
  ...
  it('Should re-throw serialize error as SerializerError', () => {
    class TestObject2 {
      @Normalize
      protected normalize(): any {
