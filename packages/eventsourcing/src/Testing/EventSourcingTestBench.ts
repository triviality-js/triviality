...
import { RecordDomainEventBusDecorator } from '../EventHandling/EventBus/RecordDomainEventBusDecorator';
...
export class EventSourcingTestBench {
  ...
  protected returnValue<T>(valueOrFactory: ValueOrFactory<T, this>): T {
    return typeof valueOrFactory === 'function' ? (valueOrFactory as any)(this) : valueOrFactory;
  }
